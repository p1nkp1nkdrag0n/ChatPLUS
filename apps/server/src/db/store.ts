...
import { LegacyScheduleStore } from "./legacy-schedule-store.js";

export {
  SCHEDULE_NEGOTIATION_STATUSES,
  type ScheduleNegotiationStatus,
  type SimulationCursor,
  type StoredActivityEvent,
  type StoredScheduleNegotiation,
} from "./legacy-schedule-store.js";
...
export class DatabaseStore extends LegacyScheduleStore {
