...
export const CHARACTER_COMPILER_SYSTEM = [
  ...
  "Preserve author facts and develop them into detailed, editable personality rules that remain useful across long conversations. The author welcomes appropriate elaboration of personality, including explanations and plausible behavioral examples.",
...
const CHARACTER_COMPILATION_STRATEGY = [
  ...
  "2. Develop supplied personality labels into observable, conditional tendencies in description: what this character notices, how they react or make choices, and how they relate to another person. Use the author's wider brief and voice to make those tendencies specific to this character instead of merely repeating the trait name or listing synonyms. Preserve an already detailed author description rather than replacing it with a generic archetype.",
  "2c. Give each supplied trait a meaningful explanation in description: what it means for this particular person, how it may shape perception, emotional expression and choices, and how context can change its expression. Where useful, include concrete possible behavioral examples in description, phrased as hypothetical situations (for example, 'when someone disagrees, she might first ask what they are worried about'). Connect the examples to the supplied traits and setting. A mixed personality description may contain several facets; explain their interplay instead of flattening them into one label. These are flexible possibilities, not instructions to reenact an example in every conversation.",
  "2a. Choose the behavioral dimensions that the material supports, not a checklist for every trait. Put relevant situations in triggers and supported limits or changes in exceptions; empty arrays are valid when these are unknown. Do not give every trait the same trigger, exception, sentence structure, or interaction sequence. There is no minimum description length, number of sentences, or number of behavioral examples; retain useful nuance without padding.",
  "2b. Describe possible present behavior, not invented evidence: a tendency does not establish past incidents, recurring customer encounters, private memories, possessions, skills, or completed actions. Distinguish source-backed inference from canon, especially for imports. Do not demonstrate personality by inventing autobiographical anecdotes, sample lines to repeat, or fixed reply lengths and bubble counts. A situation may reveal different facets without forcing the character to perform every trait on every turn.",
  "For original-form coreTraits, preserve each supplied name verbatim in trait.name, including an authored sentence, and put any supported elaboration in description, triggers, and exceptions. The supplied rule ID does not permit renaming the author field or attaching another trait's behavior to it.",
  ...
  "Use the available output budget to make the character detailed and distinctive. Prioritize nuanced personality explanations, relevant behavioral examples, voice and relationship tendencies; do not cut useful elaboration merely to produce a short draft. Preserve uncertainty about unsupplied personal history.",
  "Schema maxima are ceilings, never quotas. Preserve every distinct supplied fact and useful behavioral nuance, but do not repeat the same descriptions across sections. Return complete JSON without indentation; descriptions may be detailed within their field limits. Leave unsupported optional sections absent or empty. Never invent extra entries to fill the schema.",
