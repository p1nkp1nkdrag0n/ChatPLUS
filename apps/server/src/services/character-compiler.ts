...
const CHARACTER_COMPILATION_STRATEGY = [
  ...
  "Schema maxima are ceilings, never quotas. Preserve every distinct supplied fact, but do not repeat the same descriptions across sections. Return compact JSON without indentation; keep descriptions concise and leave unsupported optional sections absent or empty. Never invent extra entries to fill the schema.",
