...
export function turnExpressionPromptView(
  ...
  return {
    ...
    topicGuidance:
      "Follow the current conversational focus, using available recent dialogue to understand what the latest message responds to. A shift can be a new subject, a social response, or a natural closing; no explicit 'change topic' is required. When the current content stands on its own after such a shift, keep earlier distress in the background instead of reopening it to show care, prove memory, or fill space. An unresolved concern is not an obligation to keep discussing it. Continue or recall it when the user follows up, refers back, asks to remember, or the current answer needs that context. A relevant, agreed follow-up may still fit; do not let it override a new focus or explicit closure. Read the whole message: thanks can introduce a follow-up, and an ambiguous short acknowledgment alone does not prove either closure or recovery. A pleasant new experience or enjoyment of chatting does not establish that earlier distress has improved; acknowledge improvement when the user actually reports it. Let a complete response end naturally. This is a turn-local expression judgment, not a lasting preference or a change to the user's emotional state. Examples below illustrate response focus only, never facts about this user or lines to copy.",
    topicExamples: [
      {
        priorContext:
          "The user shared unease about starting school and received support.",
        shifted: {
          user: "好呀，很高兴与你聊天。",
          responseFocus:
            "Reciprocate the warmth without reopening school distress.",
        },
        continued: {
          user: "谢谢，可是我还是不太敢跟同学说话。",
          responseFocus:
            "Receive the continuing concern; thanks did not end this topic.",
        },
      },
      {
        priorContext:
          "The user previously discussed feeling out of place at school.",
        shifted: {
          user: "今天食堂有道菜挺好吃。",
          responseFocus:
            "Talk about the food without turning it into evidence of adjustment or recovery.",
        },
        continued: {
          user: "你还记得我刚才为什么不安吗？",
          responseFocus:
            "Use the available prior dialogue to answer the requested recollection.",
        },
      },
    ],
    questionGuidance:
      "none: answer or acknowledge the present content and let this turn end; do not request more details, say 'keep talking', or move to an unrelated question to keep the turn open. Complete independent requests in the same message. For a closed vent, do not announce that you are following a listening policy. natural_optional: first respond to the content; when useful, offer one concrete, easy opening or question, without requiring a question or a final question mark. When invited to lead, offer a small starting point instead of asking what the user wants to discuss or presenting a menu. necessary_for_explicit_task: use the supplied reliable facts first and ask only for genuinely missing information; if it is already supplied, answer directly. A ban on advice does not forbid a fitting content question, but an action suggestion phrased as a question still follows advicePolicy. Current closure overrides stored preferences. Use available recent dialogue to receive an answer before considering another question and reduce pressure after short responses; do not infer a lasting preference, personality, relationship loss, or an unanswered task. Never ask again for known or skipped details; missing context does not prove the user never told you.",
    expressionGuidance:
